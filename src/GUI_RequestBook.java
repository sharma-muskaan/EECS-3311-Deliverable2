...
public class GUI_RequestBook extends JFrame implements ActionListener {
	...
	JLabel lblAddPhysItem = new JLabel("Request Digital Item");
	...
	JButton btnAdd = new JButton("Request");
	 ...
	 * @throws Exception 
	 */
	public GUI_RequestBook(Account acc) throws Exception {
		this.acc = acc;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnSaveInfo) {
			...
			JOptionPane.showMessageDialog(null, "Your request has been made. It is of " + priority + " priority" );
			dispose();
			GUI_Home_VisNonFaculty window;
			
			try {
				
				window = new GUI_Home_VisNonFaculty(acc);
